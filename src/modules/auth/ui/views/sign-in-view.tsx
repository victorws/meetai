    ...
    return (
        <div className="flex flex-col gap-6">
                    ...
                    <Form {...form}>
                        <form onSubmit={form.handleSubmit(onSubmit)} className="p-6 md:p-8">
                            <div className="flex flex-col gap-6">
                                ...
                                after:insert-0 after:top-1/2 after:z-0 after:flex after:items-center afer:border-t">
            ...
            text-balance *:[a]:underline *:[a]:underline-offset-4">
                By clicking continue, you agree to our <a href="#">Terms of Sevice</a> and <a href="#">Privacy Policy</a>
            </div>
        </div>
